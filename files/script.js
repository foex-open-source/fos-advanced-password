 ...
 * @param {boolean}		config.submitOnEnter			When true the page will be submitted when the enter key is pressed when typing in the item value
 ...
 * @param {number}		[config.strengthBarWidthPct]	Width of the strength bar relative to the input field
...
FOS.item.advancedPassword.init = function (config, initJs) {
	...
	apex.debug.info('FOS - Advanced Password: ', config);
	...
	// Support submitting the page on enter
